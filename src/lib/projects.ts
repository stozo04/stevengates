...
export const FEATURED_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    image: "/projects/loan-tracker.png",
    tier: "lead",
    status: "live",
    yearStart: 2026,
  },
  ...
  },
  {
    slug: "openclaw",
    name: "OpenClaw",
    tagline: "Early adopter, then I migrated to Claude Code.",
    longPitch:
    ...
    yearStart: 2024,
    reframe:
      "Migrated off in favor of Claude Code, 2026. Listed as a credibility marker, not a current dependency.",
  },
];
